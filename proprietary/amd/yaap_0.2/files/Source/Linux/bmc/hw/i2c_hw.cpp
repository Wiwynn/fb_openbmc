...
uint32_t bmc::I2CHw::transfer([[maybe_unused]] uint32_t deviceAddr, [[maybe_unused]] int& wrBytes, [[maybe_unused]] uint8_t *wrData, [[maybe_unused]] int& rdBytes, [[maybe_unused]] uint8_t *rdData)
{
    return E_SUCCESS;
}
