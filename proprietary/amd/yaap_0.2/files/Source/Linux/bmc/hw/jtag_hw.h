/******************************************************************************/
/*! \file bmc/hw/jtag_hw.h BMC JTAG HW driver
 *
 * <pre>
...
#ifndef BMC_JTAG_HW_H
#define BMC_JTAG_HW_H
...
namespace bmc
{
class JtagHw : public IJtag, public IJtag_tapState, public IJtag_tckFrequency
{
   private:
   ...
   public:
    JtagHw(int driver, uint32_t default_tck_freq, bool use_sw_mode );
