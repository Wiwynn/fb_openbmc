/******************************************************************************/
/*! \file csJtag.h YAAP CsJtag class header.
 *
 * <pre>
...
#ifndef YAAP_CS_JTAG_CLASS_H
#define YAAP_CS_JTAG_CLASS_H
...
/******************************************************************************/
/*! The YAAP \a csJtag class.
 * 
 * This represents a chipset JTAG connection.
 ******************************************************************************/
class csJtag : public base
{
  public:

    /*! Constructor.
     * 
     * Constructs a YAAP CsJtag object, along with its member instance of \a jtag.
     * 
     * \param[in] name    The name of the object.  HDT expects this to be "csJtag1" or "csJtag2".
     ...
     */
    csJtag(const char *name, hal::IJtag *jtagHw, hal::IHeader *hdrHw);
    
  protected:
    
    //! YAAP Method: Get header status.
