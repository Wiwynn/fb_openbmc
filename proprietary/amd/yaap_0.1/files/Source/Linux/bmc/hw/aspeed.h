...
#define ETHANOL_BOARD_ID 0x04
#define DAYTONA_BOARD_ID 0x06
#define BITS_PER_BYTE    0x08
#define BYTECOUNT(bits)  ((bits + 7) >> 3)

extern const std::string hdtSelName;
extern const std::string jtagMuxOEName;
extern const std::string jtagMuxSName;
extern const std::string hdtDbgReqName;
extern const std::string PwrOkName;
extern const std::string boardID0Name;
extern const std::string boardID1Name;
extern const std::string boardID2Name;
extern const std::string boardID3Name;
...
struct jtag_trst_reset {
    ...
    uint8_t data;     // 0 means low, 1 means high - TRST pin
};
