...
bool PMTCrashlog::getCrashLog(
    ...
    std::shared_ptr<pmt::transport::EndpointIface> endpoint,
...
{
    std::pair<pmt::Status, pmt::transport::CrashLogDetails>
    ...
    if (getCrashlogDetailsResponse.first != pmt::Status::success)
    {
        return false;
    }
                                  ...
                                  boost::asio::io_service& io)
{
    ...
    std::set<std::shared_ptr<pmt::transport::EndpointIface>> endPointList =
        endpoints;
    ...
    boost::asio::spawn(io, [this, endPointList,
        ...
        std::pair<pmt::Status, uint16_t> crashlogCount;
        ...
        for (auto const& endpoint : endPointList)
        {
            ...
            if (crashlogCount.first != pmt::Status::success)
            {
                continue;
            }
