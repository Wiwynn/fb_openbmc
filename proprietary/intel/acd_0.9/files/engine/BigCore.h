...
#define CD_JSON_NUM_GNR_SQD_ENTRIES 64
#define CD_JSON_NUM_GNR_SQS_ENTRIES 64
#define CD_JSON_SQ_ENTRY_SIZE 8
#define CD_BYTE_PER_FRAME 8

#define CD_JSON_CORE_NAME "core%d"
#define CD_WAIT_ON_MCERR_KEY "WaitOnMcerr"

/* ATOM Core Specific */
#define CD_JSON_MODULE_NAME "module%d"
#define CD_ATOM_CORES_PER_MODULE 4
#define CD_MAX_MODULE 64
