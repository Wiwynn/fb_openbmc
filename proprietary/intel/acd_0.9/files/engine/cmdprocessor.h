...
#define CHACOUNTTOTAL_VAR "chacounttotal"
...
#define PLATFORM_ID_VAR "platform_id"
#define UCODE_PATCH_VER_VAR "ucode_patch_ver"
#define CJSON_VER_VAR "cjson_version"
...
{
    char* modulePath;
    bool isRemoteSection;
    uint32_t instanceLoops;
    uint32_t instanceArgumentIndex;
    void* moduleHandle;
    RemoteModuleInfo* rmModuleInfo;
    RemoteModuleConfig* rmModuleConfig;
    RemoteModuleResponse* rmModuleResponse;
} RemoteModuleSectionInfo;
