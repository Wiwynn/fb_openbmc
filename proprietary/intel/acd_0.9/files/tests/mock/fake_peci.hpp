...
class FakePeciBase
{
  public:
    ...
    virtual EPECIStatus peci_RdIAMSR_dom(uint8_t target, uint8_t domainID,
    ...
    virtual EPECIStatus peci_CrashDump_GetFrame_dom(
        uint8_t target, uint8_t domainID, uint16_t param0, uint16_t param1,
        uint16_t param2, uint8_t u8ReadLen, uint8_t* pData, uint8_t* cc) = 0;
    ...
    virtual EPECIStatus peci_CrashDump_GetFrame_dom_GoodReturnWithDelay(
        uint8_t target, uint8_t domainID, uint16_t param0, uint16_t param1,
        uint16_t param2,
    ...
    virtual EPECIStatus peci_CrashDump_GetFrame_dom_GoodReturnRetryCCWithDelay(
        uint8_t target, uint8_t domainID, uint16_t param0, uint16_t param1,
    ...
    virtual EPECIStatus peci_WrPkgConfig_dom(uint8_t target, uint8_t domainId,
...
{
  public:
    explicit PeciWithDelay(int delayMilliseconds)
    {
    ...
    EPECIStatus peci_CrashDump_GetFrame_dom_GoodReturnWithDelay(
        uint8_t target, uint8_t domainID, uint16_t param0, uint16_t param1,
        uint16_t param2, uint8_t u8ReadLen, uint8_t* pData,
        uint8_t* cc) override
    {
        std::this_thread::sleep_for(
            std::chrono::milliseconds(delayMilliseconds_));
    ...
    EPECIStatus peci_CrashDump_GetFrame_dom_GoodReturnRetryCCWithDelay(
        uint8_t target, uint8_t domainID, uint16_t param0, uint16_t param1,
        uint16_t param2, uint8_t u8ReadLen, uint8_t* pData,
        uint8_t* cc) override
    {
