...
TEST_F(ProcessLoggerTestFixture, LoggerLogValueWithoutZeroPadding)
{
    ...
    cJSON* regObj = cJSON_GetObjectItemCaseSensitive(root, "RegisterName");
...
TEST_F(ProcessLoggerTestFixture, LoggerLogValueWithZeroPaddingAllSizes)
{
    ...
    cJSON* regS8Obj =
        cJSON_GetObjectItemCaseSensitive(root, "RegisterNameSize8");
    ...
    cJSON* regS4Obj =
        cJSON_GetObjectItemCaseSensitive(root, "RegisterNameSize4");
    ...
    cJSON* regS2Obj =
        cJSON_GetObjectItemCaseSensitive(root, "RegisterNameSize2");
    ...
    cJSON* regS1Obj =
        cJSON_GetObjectItemCaseSensitive(root, "RegisterNameSize1");
