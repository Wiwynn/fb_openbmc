...
/**
 * @brief Used to avoid warnings in case of unused parameters in function pointers 
 */
...
typedef enum
{
    ...
    /** The current firmware version does not support this feature */
    ARIES_FW_VER_NOT_SUPPORTED = -17
} AriesErrorType;
