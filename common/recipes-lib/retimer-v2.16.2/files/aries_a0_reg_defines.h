...
/** Reg offset for PMA register RAWLANE_DIG_PCS_XF_RX_RECAL_BANK_OVRD */
#define ARIES_PMA_RAWLANE_DIG_PCS_XF_RX_RECAL_BANK_OVRD 0x2030
...
/** Reg offset for PMA register RAWLANEAON_DIG_RX_ADPT_IQ */
#define ARIES_PMA_RAWLANEAON_DIG_RX_ADPT_IQ 0x301d

/** Reg offset for PMA register RAWLANEAON_DIG_RX_ADAPT_DONE */
#define ARIES_PMA_RAWLANEAON_DIG_RX_ADAPT_DONE 0x301f

/** Reg offset for PMA register RAWLANEAON_DIG_RX_ADPT_IQ_B1 */
#define ARIES_PMA_RAWLANEAON_DIG_RX_ADPT_IQ_B1 0x3028

/** Reg offset for PMA register RAWLANEAON_DIG_RX_ADAPT_DONE_B1 */
#define ARIES_PMA_RAWLANEAON_DIG_RX_ADAPT_DONE_B1 0x302a

/** Reg offset for PMA register RAWLANEAON_DIG_RX_ADPT_IQ_B2 */
#define ARIES_PMA_RAWLANEAON_DIG_RX_ADPT_IQ_B2 0x30c2

/** Reg offset for PMA register RAWLANEAON_DIG_RX_ADAPT_DONE_B2 */
#define ARIES_PMA_RAWLANEAON_DIG_RX_ADAPT_DONE_B2 0x30c4
...
/** PCIe Perst low register*/
#define ARIES_PERST_N 0x604
...
/** AL Pseudo Port 0 CSR Offset */
#define ARIES_MISC_AL_PSEUDO_PORT_0_CSR_OFFSET 0x608

/** AL Pseudo Port 1 CSR Offset */
#define ARIES_MISC_AL_PSEUDO_PORT_1_CSR_OFFSET 0x778
...
/** Reg offset for PIPE Rx Eq in progress */
#define ARIES_RET_PTH_LN_MAC_PHY_RXEQINPROGRESS 0x491a
