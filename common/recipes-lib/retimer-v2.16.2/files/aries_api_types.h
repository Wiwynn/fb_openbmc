...
{
    ARIES_PTX16 = 0x0, /**< PTx16xx part numbers */
    ARIES_PTX08 = 0x1  /**< PTx08xx part numbers */
} AriesDevicePartType;
...
{
    ARIES_GEN1 = 1, /**< PCIe Gen-1 datarate (2.5 GT/s) */
    ARIES_GEN2 = 2, /**< PCIe Gen-2 datarate (5 GT/s) */
    ARIES_GEN3 = 3, /**< PCIe Gen-3 datarate (8 GT/s) */
    ARIES_GEN4 = 4, /**< PCIe Gen-4 datarate (16 GT/s) */
    ARIES_GEN5 = 5  /**< PCIe Gen-5 datarate (32 GT/s) */
...
typedef enum AriesI2cFormat
{
    ...
    ARIES_I2C_FORMAT_CMBND   /**< Astera short format with combined read
                                  transactions
                                  (only supported on PT5xx with hosts that
                                  support the SMBus block process call) */
} AriesI2CFormatType;
...
{
    ARIES_FW_UPDATE_PROGRESS_START,       /**< Firmware update start */
    ARIES_FW_UPDATE_PROGRESS_WRITE_0,     /**< Firmware write 0% */
    ARIES_FW_UPDATE_PROGRESS_WRITE_10,    /**< Firmware write 10% */
    ARIES_FW_UPDATE_PROGRESS_WRITE_20,    /**< Firmware write 20% */
    ARIES_FW_UPDATE_PROGRESS_WRITE_30,    /**< Firmware write 30% */
    ARIES_FW_UPDATE_PROGRESS_WRITE_40,    /**< Firmware write 40% */
    ARIES_FW_UPDATE_PROGRESS_WRITE_50,    /**< Firmware write 50% */
    ARIES_FW_UPDATE_PROGRESS_WRITE_60,    /**< Firmware write 60% */
    ARIES_FW_UPDATE_PROGRESS_WRITE_70,    /**< Firmware write 70% */
    ARIES_FW_UPDATE_PROGRESS_WRITE_80,    /**< Firmware write 80% */
    ARIES_FW_UPDATE_PROGRESS_WRITE_90,    /**< Firmware write 90% */
    ARIES_FW_UPDATE_PROGRESS_WRITE_DONE,  /**< Firmware write done */
    ARIES_FW_UPDATE_PROGRESS_VERIFY_0,    /**< Firmware update verify 0% */
    ARIES_FW_UPDATE_PROGRESS_VERIFY_10,   /**< Firmware update verify 10% */
    ARIES_FW_UPDATE_PROGRESS_VERIFY_20,   /**< Firmware update verify 20% */
    ARIES_FW_UPDATE_PROGRESS_VERIFY_30,   /**< Firmware update verify 30% */
    ARIES_FW_UPDATE_PROGRESS_VERIFY_40,   /**< Firmware update verify 40% */
    ARIES_FW_UPDATE_PROGRESS_VERIFY_50,   /**< Firmware update verify 50% */
    ARIES_FW_UPDATE_PROGRESS_VERIFY_60,   /**< Firmware update verify 60% */
    ARIES_FW_UPDATE_PROGRESS_VERIFY_70,   /**< Firmware update verify 70% */
    ARIES_FW_UPDATE_PROGRESS_VERIFY_80,   /**< Firmware update verify 80% */
    ARIES_FW_UPDATE_PROGRESS_VERIFY_90,   /**< Firmware update verify 90% */
    ARIES_FW_UPDATE_PROGRESS_VERIFY_DONE, /**< Firmware update verify done */
    ARIES_FW_UPDATE_PROGRESS_COMPLETE     /**< Firmware update complete */
...
typedef struct AriesDevice
{
    ...
    bool codeLoadOkay;    /**< Flag to indicate if code load reg value is
                               expected */
    bool mmHeartbeatOkay; /**< Flag indicating if Main Micro heartbeat is
                               good */
    int mm_print_info_struct_addr;  /**< AL print info struct offset
                                         (Main Micro) */
    int pm_print_info_struct_addr;  /**< AL print info struct offset
                                         (Path Micro) */
    int mm_gp_ctrl_sts_struct_addr; /**< GP ctrl status struct offset
                                         (Main Micro) */
    int pm_gp_ctrl_sts_struct_addr; /**< GP ctrl status struct offset
                                         (Path Micro) */
    int linkPathStructSize;         /**< Num bytes in link path struct */
    int numLinks;               /**< Number of bifurcated links on retimer */
    bool eFuseRead;             /**< Flag to indicate if eFuse has been read */
    ...
    int tempCalCodeRefTempC;    /**< Temp calibration code reference
                                     temperature, in degrees C */
    uint8_t eFuseCPVersion;     /**< eFuse CP program version */
    ...
    char fullPartNumber[8];         /**< Full device name string */
...
typedef struct AriesRxState
{
    ...
    int adaptIq;           /**< Adapt IQ value */
    int adaptIqB0;         /**< Adapt IQ value for bank 0 */
    int adaptDoneB0;       /**< Adapt done value for bank 0 */
    int adaptIqB1;         /**< Adapt IQ value for bank 1 */
    int adaptDoneB1;       /**< Adapt done value for bank 1 */
    int adaptIqB2;         /**< Adapt IQ value for bank 2 */
    int adaptDoneB2;       /**< Adapt done value for bank 2 */
...
/**
 * @brief Struct defining data read from receiver lanes during margining
 */
typedef struct AriesRxMarginData
{
    float eyeWidthLeft;   /**< Eye lower width bounds */
    float eyeWidthRight;  /**< Eye upper width bounds */
    float eyeHeightDown;  /**< Eye lower height bounds */
    float eyeHeightUp;    /**< Eye upper height bounds */
    uint8_t presetBefore; /**< Preset request applied before margining */
    uint8_t fomBefore;    /**< Lane FoM value from before margining */
    uint8_t
        recovCount; /**< Number of recoveries that occurred during margining */
    uint8_t presetAfter; /**< Preset request applied after margining */
    uint8_t fomAfter;    /**< Lane FoM value from after margining */
    int dfe1;            /**< DFE tap 1 value (dB) */
    int dfe2;            /**< DFE tap 2 value (dB)*/
    uint8_t iq;          /**< Rx adapt IQ value */
} AriesRxMarginDataType;
...
typedef struct AriesRxMargin
{
    ...
    int errorCountLimit;       /**< Max number of errors per lane till margining
                                    stops */
    uint8_t errorCount[2][16]; /**< Array to store error counts for each port
                               and lane */
    AriesRxMarginDataType marginData[2][16]; /**< Array to store margining data
                                                for each port and lane */
    uint8_t eyeResults[2][16][15][15]; /**< Array to store eye diagram data for
                                      each port and lane */
} AriesRxMarginType;
