...
class UsbDbgComponent : public McuFwComponent {
  ...
  uint8_t type;
  public:
    UsbDbgComponent(const std::string& fru, const std::string& comp, const std::string& name, uint8_t bus, uint8_t addr, uint8_t is_signed)
...
class UsbDbgBlComponent : public McuFwBlComponent {
  ...
  uint8_t target_id;
  public:
    UsbDbgBlComponent(const std::string& fru, const std::string& comp, uint8_t bus, uint8_t addr, uint8_t target)
