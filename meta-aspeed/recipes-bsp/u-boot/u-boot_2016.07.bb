...
do_deploy () {
    ...
    then
        ...
        install -d ${DEPLOYDIR}
        install ${B}/default/${UBOOT_BINARY} ${DEPLOYDIR}/${UBOOT_IMAGE}
        cd ${DEPLOYDIR}
    ...
    then
        ...
        then
            ...
            install ${B}/default/${UBOOT_ELF} ${DEPLOYDIR}/${UBOOT_ELF_IMAGE}
     ...
     then
         ...
         then
             ...
             install ${B}/default/${SPL_BINARY} ${DEPLOYDIR}/${SPL_IMAGE}
    ...
    if [ "x${VERIFIED_BOOT}" != "x" ]; then
        install ${B}/recovery/${UBOOT_BINARY} ${DEPLOYDIR}/${UBOOT_RECOVERY_IMAGE}
    ...
    if [ "x${UBOOT_ENV}" != "x" ]
    then
        install ${B}/${UBOOT_ENV_BINARY} ${DEPLOYDIR}/${UBOOT_ENV_IMAGE}
