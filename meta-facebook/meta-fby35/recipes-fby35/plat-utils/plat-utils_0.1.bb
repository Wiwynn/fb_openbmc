...
do_install() {
  ...
  # install check_power_status.sh
  install -m 755 check_power_status.sh ${D}${sysconfdir}/init.d/check_power_status.sh
  update-rc.d -r ${D} check_power_status.sh start 65 5 .
