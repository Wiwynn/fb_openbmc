...
//ISL28022 CMD INFO
#define ISL28022_SHUNT_VOLTAGE  (0x01)
...
#define NEW_MEDUSA_HSC_ADM1272_ADDR 0x1c
#define NEW_MEDUSA_HSC_LTC4287_ADDR 0x46

#define MEDUSA_ADC_ISL28022_PSU_ADDR 0x47
#define MEDUSA_ADC_ISL28022_GND_ADDR 0x43
#define MEDUSA_ADC_INA238_PSU_ADDR 0x44
#define MEDUSA_ADC_INA238_GND_ADDR 0x41

#define DELTA_1_PDB_ADDR 0xC2
#define DELTA_2_PDB_ADDR 0xC0
#define RNS_PDB_ADDR 0xB4
#define FLEX_1_PDB_ADDR 0xC2
#define FLEX_2_PDB_ADDR 0xC0
...
enum {
  ...
  BIC_GL_SENSOR_MB_DIMMA0_TEMP_C = 0x5,
  BIC_GL_SENSOR_MB_DIMMA1_TEMP_C = 0x6,
  BIC_GL_SENSOR_MB_DIMMA2_TEMP_C = 0x7,
  BIC_GL_SENSOR_MB_DIMMA3_TEMP_C = 0x8,
  BIC_GL_SENSOR_MB_DIMMA4_TEMP_C = 0x9,
  BIC_GL_SENSOR_MB_DIMMA5_TEMP_C = 0x0A,
  BIC_GL_SENSOR_MB_DIMMA6_TEMP_C = 0x0B,
  BIC_GL_SENSOR_MB_DIMMA7_TEMP_C = 0x0C,
  ...
  BIC_GL_SENSOR_MB_VR_DIMMA0_PMIC_PWR_W = 0x36,
  BIC_GL_SENSOR_MB_VR_DIMMA1_PMIC_PWR_W = 0x37,
  BIC_GL_SENSOR_MB_VR_DIMMA2_PMIC_PWR_W = 0x38,
  BIC_GL_SENSOR_MB_VR_DIMMA3_PMIC_PWR_W = 0x39,
  BIC_GL_SENSOR_MB_VR_DIMMA4_PMIC_PWR_W = 0x3A,
  BIC_GL_SENSOR_MB_VR_DIMMA5_PMIC_PWR_W = 0x3B,
  BIC_GL_SENSOR_MB_VR_DIMMA6_PMIC_PWR_W = 0x3C,
  BIC_GL_SENSOR_MB_VR_DIMMA7_PMIC_PWR_W = 0x3D,
  BIC_GL_SENSOR_MB_SOC_CPU_PWR_W = 0x3E,
  BIC_GL_SENSOR_MB_TOTAL_DIMM_PWR_W = 0x3F,

  //BIC - javaisland temperature sensors
  BIC_JI_SENSOR_MB_INLET_TEMP_C = 0x01,
  BIC_JI_SENSOR_MB_OUTLET_TEMP_C = 0x02,
  BIC_JI_SENSOR_FIO_FRONT_TEMP_C = 0x03,
  BIC_JI_SENSOR_MB_SOC_CPU_TEMP_C = 0x04,
  BIC_JI_SENSOR_MB_FPGA_TEMP_C = 0x05,
  BIC_JI_SENSOR_MB_E1S_SSD_TEMP_C = 0x06,
  BIC_JI_SENSOR_MB_HSC_TEMP_C = 0x07,
  BIC_JI_SENSOR_MB_CPUDVDD_TEMP_C = 0x08,
  BIC_JI_SENSOR_MB_CPUVDD_TEMP_C = 0x09,
  BIC_JI_SENSOR_MB_SOCVDD_TEMP_C = 0x0A,
  BIC_JI_SENSOR_MB_RETIMER_TEMP_C = 0x0B,
  BIC_JI_SENSOR_MB_LPDDR5_UP_TEMP_C = 0x0C,
  BIC_JI_SENSOR_MB_LPDDR5_DOWN_TEMP_C = 0x0D,

  //BIC - javaisland voltage sensors
  BIC_JI_SENSOR_MB_HSC_INPUT_VOLT_V = 0x10,
  BIC_JI_SENSOR_MB_ADC_P12V_STBY_VOLT_V = 0x11,
  BIC_JI_SENSOR_MB_ADC_VDD_1V8_VOLT_V = 0x12,
  BIC_JI_SENSOR_MB_ADC_P3V3_STBY_VOLT_V = 0x13,
  BIC_JI_SENSOR_MB_ADC_SOCVDD_VOLT_V = 0x14,
  BIC_JI_SENSOR_MB_ADC_P3V_BAT_VOLT_V = 0x15,
  BIC_JI_SENSOR_MB_ADC_CPUVDD_VOLT_V = 0x16,
  BIC_JI_SENSOR_MB_ADC_FPGA_VCC_AO_VOLT_V = 0x17,
  BIC_JI_SENSOR_MB_ADC_1V2_VOLT_V = 0x18,
  BIC_JI_SENSOR_MB_ADC_VDD_3V3_VOLT_V = 0x19,
  BIC_JI_SENSOR_MB_ADC_P1V2_STBY_VOLT_V = 0x1A,
  BIC_JI_SENSOR_MB_ADC_FBVDDQ_VOLT_V = 0x1B,
  BIC_JI_SENSOR_MB_ADC_FBVDDP2_VOLT_V = 0x1C,
  BIC_JI_SENSOR_MB_ADC_FBVDD1_VOLT_V = 0x1D,
  BIC_JI_SENSOR_MB_ADC_P5V_STBY_VOLT_V = 0x1E,
  BIC_JI_SENSOR_MB_ADC_CPU_DVDD_VOLT_V = 0x1F,
  BIC_JI_SENSOR_MB_E1S_SSD_VOLT_V = 0x20,
  BIC_JI_SENSOR_MB_CPUDVDD_VOLT_V = 0x21,
  BIC_JI_SENSOR_MB_CPUVDD_VOLT_V = 0x22,
  BIC_JI_SENSOR_MB_SOCVDD_VOLT_V = 0x23,

  //BIC - javaisland current sensors
  BIC_JI_SENSOR_MB_HSC_OUTPUT_CURR_A = 0x25,
  BIC_JI_SENSOR_MB_E1S_SSD_CURR_A = 0x26,
  BIC_JI_SENSOR_MB_CPUDVDD_CURR_A = 0x27,
  BIC_JI_SENSOR_MB_CPUVDD_CURR_A = 0x28,
  BIC_JI_SENSOR_MB_SOCVDD_CURR_A = 0x29,

  //BIC - javaisland power sensors
  BIC_JI_SENSOR_MB_CPU_PWR_W = 0x30,
  BIC_JI_SENSOR_MB_HSC_INPUT_PWR_W = 0x31,
  BIC_JI_SENSOR_MB_E1S_SSD_PWR_W = 0x32,
  BIC_JI_SENSOR_MB_CPUDVDD_PWR_W = 0x33,
  BIC_JI_SENSOR_MB_CPUVDD_PWR_W = 0x34,
  BIC_JI_SENSOR_MB_SOCVDD_PWR_W = 0x35,

  //BIC - javaisland state sensors
  BIC_JI_SENSOR_MB_CPU_Throttle = 0x40,
  BIC_JI_SENSOR_MB_POWER_BREAK = 0x41,
  BIC_JI_SENSOR_MB_SPARE_CHANNEL = 0x42,
  BIC_JI_SENSOR_MB_PAGE_RETIRE_CNT = 0x43,
...
//HSC INFO
typedef enum {
  MEDUSA_ADC_ISL28022_PSU = 0,
  MEDUSA_ADC_ISL28022_GND,
