...
MAPTOSTRING root_port_common_mapping[] = {
    ...
    {0x00, 0, 0x04, 0xFF, "ieh4", "ieh"}, //  ieh device
    {0x05, 0, 0x04, 0xFF, "ieh4", "ieh"}, //  ieh device
    {0x0A, 0, 0x04, 0xFF, "ieh4", "ieh"}, //  ieh device
    {0x47, 0, 0x04, 0xFF, "ieh4", "ieh"}, //  ieh device
    {0x83, 0, 0x04, 0xFF, "ieh4", "ieh"}, //  ieh device
    {0xBF, 0, 0x04, 0xFF, "ieh4", "ieh"}, //  ieh device
    // Halfdome
...
pal_parse_sys_sts_event(uint8_t fru, uint8_t *event_data, char *error_log) {
  ...
  switch (event) {
    ...
    case SYS_CPU_THERM_TRIP_OR_VR_HOT:
      ...
      break;
    case SYS_RETIMER_FAULT:
      strcat(error_log, "Retimer fault");
      break;
