...
board_routes = [
    ...
    "/api/sys/sensors/psu3",
    "/api/sys/sensors/psu4",
    "/api/sys/sensors/pim1",
    "/api/sys/sensors/pim2",
    "/api/sys/sensors/pim3",
    "/api/sys/sensors/pim4",
    "/api/sys/sensors/pim5",
