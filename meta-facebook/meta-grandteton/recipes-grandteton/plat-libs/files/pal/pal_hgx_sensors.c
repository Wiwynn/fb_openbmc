...
PAL_SENSOR_MAP hgx_sensor_map[] = {
  ...
  {"GPU_SXM_1_TEMP_1"   , 0 , read_snr, false, {0.01, 0, 0, 0, 0, 0, 0, 0}, TEMP}, //0x34
  ...
  {"GPU_SXM_2_TEMP_1"   , 0 , read_snr, false, {0.01, 0, 0, 0, 0, 0, 0, 0}, TEMP}, //0x3C
  ...
  {"GPU_SXM_3_TEMP_1"   , 0 , read_snr, false, {0.01, 0, 0, 0, 0, 0, 0, 0}, TEMP}, //0x44
  ...
  {"GPU_SXM_4_TEMP_1"   , 0 , read_snr, false, {0.01, 0, 0, 0, 0, 0, 0, 0}, TEMP}, //0x4C
  ...
  {"GPU_SXM_5_TEMP_1"   , 0 , read_snr, false, {0.01, 0, 0, 0, 0, 0, 0, 0}, TEMP}, //0x54
  ...
  {"GPU_SXM_6_TEMP_1"   , 0 , read_snr, false, {0.01, 0, 0, 0, 0, 0, 0, 0}, TEMP}, //0x5C
  ...
  {"GPU_SXM_7_TEMP_1"   , 0 , read_snr, false, {0.01, 0, 0, 0, 0, 0, 0, 0}, TEMP}, //0x64
  ...
  {"GPU_SXM_8_TEMP_1"   , 0 , read_snr, false, {0.01, 0, 0, 0, 0, 0, 0, 0}, TEMP}, //0x6C
